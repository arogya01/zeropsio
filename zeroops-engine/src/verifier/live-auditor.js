 ...
 * CommonJS export for Node runtime.
 */
...
class LiveAuditor {
  constructor(options = {}) {
    ...
    this.simulateHttpFailure = false;
    this.simulateDbFailure = false;
    this.simulateCacheFailure = false;
    this.simulateQueueFailure = false;
  }
