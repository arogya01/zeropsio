 ...
 */
export function generateFrontend(spec: StackTopologySpec, _options?: CodeTemplateOptions): Record<string, string> {
 ...
 */
export function generateApi(spec: StackTopologySpec, options?: CodeTemplateOptions): Record<string, string> {
  const files: Record<string, string> = {};
 ...
 */
export function generateWorker(spec: StackTopologySpec, _options?: CodeTemplateOptions): Record<string, string> {
  const files: Record<string, string> = {};
...
def process_job(job_data):
    logging.info(f"Processing audio/video queue job payload with model {MODEL_NAME}: {job_data}")
    time.sleep(0.1)
    logging.info("Audio extraction and Whisper transcription job completed successfully.")
 ...
 */
export function generateSqlMigrations(spec: StackTopologySpec, _options?: CodeTemplateOptions): Record<string, string> {
  const files: Record<string, string> = {};
 ...
 */
export function generateTemplates(spec: StackTopologySpec, options?: CodeTemplateOptions): Record<string, string> {
